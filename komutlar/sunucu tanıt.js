...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .addField('Sunucu burada tanıtıldı! (https://discord.gg/wTxVv8.')
  .addField('12 saat Sonra sunucunuzu Tekrardan Tanıtabilirsiniz.')
  .addField('Sunucunu tanıtabilmek için beni ekle! https://discord.gg/wTxVv8')
  .setColor('GREEN')
 message.channel.sendEmbed(embed);
  ...
  message.channel.send({embed: {
      description: '**BAŞARISIZ TANITIM**:sparkles:  \n\nBu komut zaten kullanılmış!\n\nSunucunu 12 saate 1 defa tanıtabilirsin! :flag_tr:  \n\n[SARI - Destek Sunucusu](https://discord.gg/wTxVv8) \n[Beni Sunucuna Ekleyebilmek İçin Tıklaman Yeterli!](https://goo.gl/2WhBSB)'
            }});
  }
};
